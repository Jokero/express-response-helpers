...
module.exports = function(paramsConfigFunction, options) {
    ...
    var dropFirstLevelUndefinedParams = options.hasOwnProperty('dropFirstLevelUndefinedParams') ? options.dropFirstLevelUndefinedParams : false;

    return function(req, res, next) {
        var paramsConfig  = paramsConfigFunction(req);
        var requestParams = _.merge({}, req.query, req.body, req.params);

        validate(requestParams, paramsConfig, { dropFirstLevelUndefinedFields: dropFirstLevelUndefinedParams })
